...
class MainTest {
    ...
    fun testDay7CountV2() {
        assertEquals(
            5905,
            Day7.countV2(TEST_INPUT_PATH.format("Day7"))
        )
    }
    ...
    fun testDay8CountV2() {
        assertEquals(
            6,
            Day8.countV2(TEST_INPUT2_PATH.format("Day8"))
        )
    }
    ...
    fun testDay9CountV2() {
        assertEquals(
            2,
            Day9.countV2(TEST_INPUT_PATH.format("Day9"))
        )
    }
    ...
    @Test
    fun testDay10CountV2() {
        assertEquals(
            1,
            Day10.countV2(TEST_INPUT_PATH.format("Day10"))
        )
    }
    ...
    @Test
    fun testDay13CountV2() {
        assertEquals(
            400,
            Day13.countV2(TEST_INPUT_PATH.format("Day13"))
        )
    }
    ...
    @Test
    fun testDay14CountV2() {
        assertEquals(
            64,
            Day14.countV2(TEST_INPUT_PATH.format("Day14"))
        )
    }
    ...
    fun testDay15Count2() {
        assertEquals(
            52,
            Day15.count(TEST_INPUT2_PATH.format("Day15"))
        )
    }

    @Test
    fun testDay15CountV2() {
        assertEquals(
            145,
            Day15.countV2(TEST_INPUT_PATH.format("Day15"))
        )
    }
    ...
    @Test
    fun testDay16CountV2() {
        assertEquals(
            51,
            Day16.countV2(TEST_INPUT_PATH.format("Day16"))
        )
    }
    ...
    fun testDay17Count2() {
        assertEquals(
            7,
            Day17.count(TEST_INPUT2_PATH.format("Day17"))
        )
    }

    @Test
    fun testDay17CountV2() {
        assertEquals(
            94,
            Day17.countV2(TEST_INPUT_PATH.format("Day17"))
        )
    }
    ...
    fun testDay18Count2() {
        assertEquals(
            59,
            Day18.count(TEST_INPUT2_PATH.format("Day18"))
        )
    }
